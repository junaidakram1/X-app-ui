...
const ImageEditor = ({
  ...
  return (
    <div className="fixed w-screen h-screen left-0 top-0 bg-black bg-opacity-75 z-10 flex items-center justify-center">
      <div className="bg-black rounded-xl p-12 flex flex-col gap-4 text-white">
        {/* TOP */}
        <div className="flex items-center justify-between">
          ...
          <button
            className="py-2 px-4 rounded-full bg-white text-black font-bold hover:bg-gray-200"
            onClick={onClose}
          >
            Save
          </button>
        ...
        {/* IMAGE CONTAINER */}
        <div className="w-[600px] h-[400px] flex items-center justify-center bg-gray-900 rounded-lg overflow-hidden">
          <Image
            src={previewURL}
            alt=""
            width={600}
        ...
        <div className="flex items-center justify-between text-sm bg-gray-900 p-3 rounded-lg">
          <div className="flex items-center gap-8">
            ...
            >
              <svg width={24} viewBox="0 0 24 24">
                <path
                  className={
                    settings.type === "wide" ? "fill-blue-500" : "fill-white"
                  }
            ...
            >
              <svg width={24} viewBox="0 0 24 24">
                <path
                  className={
                    settings.type === "square" ? "fill-blue-500" : "fill-white"
                  }
          ...
          <div
            className={`cursor-pointer py-1 px-4 rounded-full text-black font-bold hover:opacity-80 ${
